...
namespace SAS.StateMachineGraph.Editor
{
    ...
    {
        public ParentStateMachineNode(Object targetObject, Vector2Int position, bool isDefault, Action<BaseNode> startTransition, Action<BaseNode> makeTransition, Action<StateMachineNode> selectStateMachine) :
                                 base(targetObject, position, isDefault, startTransition, makeTransition, null, selectStateMachine, null)
        {
            Prefix = "(Up)";
        }
